...
export const formSections: SectionConfig[] = [
  {
    ...
    fields: [
      ...
      { id: "state", label: "State", type: "conditionalSelect", required: false, options: usaStates },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "accident_country", label: "Accident Country", type: "select", required: true, options: countryOptions },
      { id: "accident_state", label: "Accident State", type: "conditionalSelect", required: true, options: usaStates },
