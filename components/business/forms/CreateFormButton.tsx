    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button
                    variant={"outline"}
                    className="group rounded-xl shadow border border-primary/20 h-[210px] min-w-[280px]  w-full xl:max-w-[380px] items-center justify-center flex flex-col hover:border-primary hover:cursor-pointer border-dashed gap-4"
                >
